...
clf = linear_model.LogisticRegression(verbose = 1 , C = 0.001  , penalty = 'l2')
...
import csv as csv
predictions_file = open("/Users/shamitlal/Desktop/shamit/sem 6/minor/speech-emotion-recognition-master/csv_4.csv", "wb")
